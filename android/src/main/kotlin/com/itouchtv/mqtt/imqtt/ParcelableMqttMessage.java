...
public class ParcelableMqttMessage extends MqttMessage implements Parcelable {
  ...
  public void writeToParcel(Parcel parcel, int flags) {
	 ...
	 */
	public static final Creator<com.itouchtv.mqtt.imqtt.ParcelableMqttMessage> CREATOR = new Creator<com.itouchtv.mqtt.imqtt.ParcelableMqttMessage>() {

		/**
		 * Creates a message from the parcel object
		 */
		@Override
		public com.itouchtv.mqtt.imqtt.ParcelableMqttMessage createFromParcel(Parcel parcel) {
			return new com.itouchtv.mqtt.imqtt.ParcelableMqttMessage(parcel);
		}

		/**
		 * creates an array of type {@link com.itouchtv.mqtt.imqtt.ParcelableMqttMessage}[]
		 * 
		 */
		@Override
		public com.itouchtv.mqtt.imqtt.ParcelableMqttMessage[] newArray(int size) {
			return new com.itouchtv.mqtt.imqtt.ParcelableMqttMessage[size];
		}
	};
}
