...
import com.itouchtv.mqtt.imqtt.mqttv3.BufferedMessage;
...
import com.itouchtv.mqtt.imqtt.mqttv3.MqttTopic;
...
//		log.fine(CLASS_NAME,methodName,"204", new Object[]{new Integer(rc)});
    ...
    public void shutdownConnection(MqttToken token, MqttException reason) {
        Log.d("hwz", "shutdownConnection:ClientComms.java");
...
//		log.fine(CLASS_NAME,methodName,"804",null, ex);
        ...
        Log.d("hwz", "shutdownConnection:ClientComms#checkForActivity");
    ...
    /**
     * 自动重连后，优先将已缓存的离线消息发送出去，然后才能继续发送其他消息
