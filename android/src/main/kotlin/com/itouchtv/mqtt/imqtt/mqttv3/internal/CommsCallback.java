...
public class CommsCallback implements Runnable {
    ...
    public void run() {
        ...
        while (running) {
            try {
                ...
                running = false;
                Log.d("hwz", "shutdownConnection:CommsCallback#run");
    ...
    public void reconnectComplete() {
        if (reconnectInternalCallback != null) {
            reconnectInternalCallback.connectComplete(true, "");
        }
    }
    ...
    public void asyncOperationComplete(MqttToken token) {
        ...
        if (running) {
            ...
            try {
                ...
                Log.d("hwz", "shutdownConnection:CommsCallback#asyncOperationComplete");
