...
import com.itouchtv.mqtt.imqtt.mqttv3.IMqttAsyncClient;
...
import com.itouchtv.mqtt.imqtt.mqttv3.MqttCallback;
...
public class MqttAndroidClient extends BroadcastReceiver implements IMqttAsyncClient {
    ...
    public enum Ack {
         ...
         * to {@link com.itouchtv.mqtt.imqtt.MqttAndroidClient} using {@link com.itouchtv.mqtt.imqtt.MqttAndroidClient#acknowledgeMessage(String)}
         */
        MANUAL_ACK
    }
    ...
    private final class MyServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            mqttService = ((com.itouchtv.mqtt.imqtt.MqttServiceBinder) binder).getService();
            bindedService = true;
    ...
    private com.itouchtv.mqtt.imqtt.MqttService mqttService;
    ...
    public IMqttToken connect(MqttConnectOptions options, Object userContext,
        ...
        if (mqttService == null) { // First time - must bind to the service 首次启动服务
            ...
            serviceStartIntent.setClass(myContext, com.itouchtv.mqtt.imqtt.MqttService.class);
            Object service = myContext.startService(serviceStartIntent);
            if (service == null) {//如果服务启动失败则回调连接失败
                IMqttActionListener listener = token.getActionCallback();
                if (listener != null) {
                    listener.onFailure(token, new RuntimeException("cannot start MqttService "));
                }
            }
            ...
            pool.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!receiverRegistered) registerReceiver(com.itouchtv.mqtt.imqtt.MqttAndroidClient.this);
                }
    ...
    public IMqttDeliveryToken publish(String topic, byte[] payload, int qos,
        ...
        com.itouchtv.mqtt.imqtt.MqttDeliveryTokenAndroid token = new com.itouchtv.mqtt.imqtt.MqttDeliveryTokenAndroid(this, userContext, callback, message);
        String activityToken = storeToken(token);
    ...
    public IMqttDeliveryToken publish(String topic, MqttMessage message,
            ...
            throws MqttException, MqttPersistenceException {
        com.itouchtv.mqtt.imqtt.MqttDeliveryTokenAndroid token = new com.itouchtv.mqtt.imqtt.MqttDeliveryTokenAndroid(
     ...
     * connect and subscribe can be tracked using the {@link com.itouchtv.mqtt.imqtt.mqttv3.MqttToken} returned
     ...
     *                  {@link com.itouchtv.mqtt.imqtt.ParcelableMqttMessage})
    ...
    private void messageArrivedAction(Bundle data) {
        if (callback != null) {
            ...
            com.itouchtv.mqtt.imqtt.ParcelableMqttMessage message = data.getParcelable(MqttServiceConstants.CALLBACK_MESSAGE_PARCEL);
            try {
    ...
    public void unregisterResources() {
        if (myContext != null && receiverRegistered) {
            synchronized (com.itouchtv.mqtt.imqtt.MqttAndroidClient.this) {
