...
package com.itouchtv.mqtt.imqtt.mqttv3;


import com.itouchtv.mqtt.imqtt.mqttv3.internal.ClientComms;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.ConnectActionListener;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.DisconnectedMessageBuffer;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.ExceptionHelper;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.LocalNetworkModule;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.NetworkModule;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.SSLNetworkModule;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.TCPNetworkModule;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.security.SSLSocketFactoryFactory;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.websocket.WebSocketNetworkModule;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.websocket.WebSocketSecureNetworkModule;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.wire.MqttDisconnect;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.wire.MqttPublish;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.wire.MqttSubscribe;
import com.itouchtv.mqtt.imqtt.mqttv3.internal.wire.MqttUnsubscribe;
import com.itouchtv.mqtt.imqtt.mqttv3.persist.MemoryPersistence;
import com.itouchtv.mqtt.imqtt.mqttv3.persist.MqttDefaultFilePersistence;
import com.itouchtv.mqtt.imqtt.mqttv3.util.Debug;
...
//				}
    ...
    public IMqttToken connect(MqttConnectOptions options, Object userContext, IMqttActionListener callback)
        ...
        comms.setReconnectCallback(new MqttCallbackExtended() {
            ...
            public void connectComplete(boolean reconnect, String serverURI) {
                //自动重连完成会回调到此处
                //重连后需要主动订阅掉线时已订阅的主题
                //并在订阅成功后需要发消息到willTopic告诉java后台已订阅该主题
                if (reconnect) {
                    TMQClient.getInstance().subscribeTopicsAfterAutoReconnect();
                }
            }
            ...
            public void connectionLost(Throwable cause) {
                ...
                if (automaticReconnect) {
                    ...
                    reconnecting = true;
                    stopReconnectCycle();
                    startReconnectCycle(reconnectDelay);
                }
            }
        });
    ...
    public void reconnect() throws MqttException {
        ...
        stopReconnectCycle();
        startReconnectCycle(0);
    }

    private void startReconnectCycle(int delay) {
        try {
    ...
    private class ReconnectTask extends TimerTask {
        ...
        public void run() {
            try {
                ...
                TMQClient.getInstance().setupWill(connOpts);
                connect(connOpts, userContext, new IMqttActionListener() {
                    ...
                    public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                        //Automatic Reconnect failed, rescheduling
